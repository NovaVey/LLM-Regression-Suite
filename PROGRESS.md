...
**Still outstanding:** the 3-minute demo video (§9's exit criteria) — this requires screen-recording/video-editing tooling this environment doesn't have; raising this to the user directly rather than silently skipping it.
